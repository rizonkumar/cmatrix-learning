        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="lg:hidden relative p-3 rounded-xl text-gray-700 hover:text-blue-600 hover:bg-blue-50/80 dark:text-gray-300 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 transition-all duration-300 hover:scale-105 group cursor-pointer"
            >
            ...
            {isAuthenticated ? (
              <div className="hidden md:flex items-center space-x-4">
                <div
                  className="flex items-center space-x-3 px-3 py-2 rounded-xl bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:bg-gray-100/50 dark:hover:bg-gray-700/50 transition-all duration-300 group cursor-pointer"
                  onClick={() => {
                    const dashboardPath =
                ...
                <Button
                  ...
                  className="flex items-center space-x-2 px-4 py-2.5 rounded-xl border-red-200 hover:border-red-300 hover:bg-red-50 dark:border-red-800 dark:hover:bg-red-900/20 transition-all duration-300 hover:scale-105 group cursor-pointer"
                >
                ...
                <div className="pt-6 border-t border-gray-200/50 dark:border-gray-700/50 md:hidden">
                  {isAuthenticated ? (
                    <div className="space-y-4">
                      <div
                        className="flex items-center space-x-3 px-4 py-3 rounded-2xl bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm cursor-pointer hover:bg-gray-100/50 dark:hover:bg-gray-700/50 transition-all duration-300"
                        onClick={() => {
                          const dashboardPath =
                            user?.role === "admin" ? "/admin" : "/dashboard";
                          handleNavigation(dashboardPath);
                      ...
                      <Button
                        onClick={handleLogout}
                        className="w-full py-4 rounded-2xl bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white flex items-center justify-center space-x-2 font-semibold shadow-lg hover:shadow-xl hover:shadow-red-500/25 transition-all duration-300 hover:scale-105 cursor-pointer"
                      >
