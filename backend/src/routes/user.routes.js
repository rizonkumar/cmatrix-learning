...
router.route('/change-password').post(validatePasswordChange, userController.changePassword);
...
router.route('/:userId/role')
    .put(authorizeRoles('admin'), validateRoleUpdate, userController.updateUserRole);

router.route('/:userId/streak/reset')
