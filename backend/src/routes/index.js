...
import { uploadAvatarSingle, uploadThumbnailSingle, uploadCourseContentSingle, uploadMultiple } from "../services/fileUpload.service.js";
...
// File upload routes
router.post(`${API_VERSION}/users/avatar`, verifyJWT, uploadAvatarSingle, (req, res) => {
  if (!req.file) {
...
router.post(`${API_VERSION}/courses/thumbnail`, verifyJWT, uploadThumbnailSingle, (req, res) => {
  if (!req.file) {
    return res.status(400).json(new ApiResponse(400, {}, "No file uploaded"));
  }
...
router.post(`${API_VERSION}/courses/content`, verifyJWT, uploadCourseContentSingle, (req, res) => {
  if (!req.file) {
    return res.status(400).json(new ApiResponse(400, {}, "No file uploaded"));
  }
...
router.post(`${API_VERSION}/upload/multiple`, verifyJWT, uploadMultiple, (req, res) => {
  const uploadedFiles = {};
